...
PRODUCT_COPY_FILES += \
    vendor/aosp/config/permissions/privapp-permissions-tenx-system_ext.xml:$(TARGET_COPY_OUT_SYSTEM_EXT)/etc/permissions/privapp-permissions-tenx-system_ext.xml \
